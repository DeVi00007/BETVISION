  ...
  return (
    <section className="relative min-h-screen w-full flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
        {/* Eyebrow badge */}
        <div className="inline-flex items-center gap-2 border border-bv-blue/60 rounded-full px-4 py-1.5 mb-8">
        ...
        {/* Headline */}
        <h1 className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl xl:text-[96px] font-black tracking-[-0.04em] leading-[0.95] mb-6">
          <span className="text-white block">A JÖVŐ</span>
          <span className="text-bv-blue block mt-2">TIPPMIX TIPPEK</span>
        </h1>

        {/* Subheadline */}
        <p className="text-bv-text-secondary text-base md:text-lg max-w-xl mx-auto mb-10 leading-relaxed">
